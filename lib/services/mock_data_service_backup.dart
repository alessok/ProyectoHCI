...
class MockDataService {
  ...
  static final List<Professor> _professors = [
    Professor(
      ...
      department: 'Ing. Sistemas', // Unificado
    ...
    Professor(
      ...
      department: 'Comunicación', // Cambiado de Medicina a Comunicación
      courses: ['Comunicación Corporativa', 'Relaciones Públicas', 'Marketing Digital'], // Cursos actualizados
      averageRating: 4.2,
      totalReviews: 134,
      photoUrl: null,
      bio: 'Doctor en Comunicación con especialización en Comunicación Corporativa, con 20 años de experiencia docente.', // Bio actualizada
    ),
    Professor(
      id: '6',
    ...
    Professor(
      ...
      department: 'Medicina',
      courses: ['Cardiología', 'Medicina Interna', 'Emergencias Médicas'],
      averageRating: 4.6,
      totalReviews: 102,
      photoUrl: null,
      bio: 'Doctor en Medicina, cardiólogo con especialización en medicina de emergencias.',
    ),
    Professor(
      id: '15',
